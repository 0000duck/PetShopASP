...
namespace PetShopASP.Controllers
{
    public class ClientesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Sobrenome,CPF,CEP,Numero,Complemento,Telefone,Celular,Email_primario,Email_secundario")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
