...
namespace PetShopASP.Controllers
{
    public class LoginsController : Controller
    {
        ...
        public LoginsController(ContextModel context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Senha,Email,Email_suporte,Cel,Hierarquia")] Login login)
        {
            if (id != login.Id)
            {
                return NotFound();
